...
try {
  ...
  & $Zig c++ @common src/core.cpp src/platform.cpp tests/platform_tests.cpp -lwinhttp -luser32 -ladvapi32 -o build/platform_tests.exe
  ...
  & $Zig c++ @common src/core.cpp src/render.cpp tests/render_tests.cpp -ld2d1 -ldwrite -lgdi32 -luser32 -lole32 -o build/render_tests.exe
  ...
  if(!$TestsOnly) {
    ...
    & $Zig c++ @common -municode '-Wl,--subsystem,windows' src/core.cpp src/platform.cpp src/render.cpp src/main.cpp build/app.res -lwinhttp -ld2d1 -ldwrite -lgdi32 -luser32 -lshell32 -ladvapi32 -lole32 -lshlwapi -o build/SanctuaryTimers.exe
