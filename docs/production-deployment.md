...
4. Package version 0.1.1, run native and installer tests, review the deployment change, push and verify Windows CI, then publish a GitHub release with the portable ZIP, installer and SHA-256 manifest.
...
Release publication and downloaded-build installation verification pending.
